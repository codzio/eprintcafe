            ...
            <table>
                ...
                <thead>
                    ...
                    <tr style="text-align: left;">
                        <th style="width:21%; padding-left:10px;">Party Name : {{ $customerName }}</th>
                    </tr>
                </thead>
                    ...
                    <tr>
                        <table class="detailed" style="border-left:none; border-right:none;">
                            ...
                            <tr class="border-top row-flex color_">
                                ...
                                <td style="text-align: right; width: 47px;">{{ $order->qty }}x{{ $order->no_of_copies }}</td>
                                ...
                                <td style="text-align: right; border-right:0;">{{ ($order->qty*$priceData->price+($priceData->binding+$priceData->lamination+$priceData->cover))*$order->no_of_copies }}</td>
                            </tr>
                        ...
                        <td>
                            ...
                            <table style="width: 43%;border-left: none;font-size: .8rem;text-align: right;border-right: none;border-top: none; border-bottom:0;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-right: 5px;padding-left: 5px;border-bottom: 1px solid gray;"><b>{{ $order->paid_amount-$gstCalc->igst }}</b></td>
                                </tr>
                                <tr>
