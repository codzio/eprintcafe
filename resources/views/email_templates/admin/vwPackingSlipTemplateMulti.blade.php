                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="head" style="width: 77.5%; padding-left:190px;">
                            ...
                            <table>
                                ...
                                <!-- <tr class="inp">
                                    <td style="display:flex; align-items:end; padding-top:5px">
                                        ...
                                        <span style="width:100%; height:auto;background:transparent; border-bottom:2px solid #000; font-size:14px; margin-left:4px;">{{ $order->paid_amount }}</span>
                                    </td>
                                </tr> -->
                                <tr class="inp">
                            ...
                            @if($orderItem)
                                <h3 style="font-style: italic; margin-top:12px;">Orders Inside</h3>
                                @foreach($orderItem as $orderIt)
                                    <p style="margin-left:20px">- {{ $orderIt->product_name }}</p>
                                @endforeach
                            @endif
