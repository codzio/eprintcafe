                                    ...
                                    <div style="text-align:center; margin:0 15px 34px 15px">
                                        ...
                                        <div style="margin-bottom: 10px">
                                            <a href="#" rel="noopener" target="_blank">
                                                <img alt="" src="{{ asset('public/admin/media/email/logo-1.svg') }}" style="height: 35px" />
                                            </a>
                                        </div>
                                        <!--end:Logo-->
                                        <!--begin:Media-->
                                        <div style="margin-bottom: 15px">
                                            <img alt="Logo" src="{{ asset('public/backend') }}/media/email/icon-positive-vote-1.svg" />
                                        </div>
                                        <!--end:Media-->
                                        <!--begin:Text-->
                                        <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                            ...
                                            <p style="margin-bottom:9px; color:#7E8299;">No worries! You can reset your password by clicking the button below.</p>

                                            <a href="{{ route('adminResetPassword', ['token' => $token]) }}" target="_blank" style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">Reset Password</a> 
                                            
                                            <p style="margin-bottom:2px; color:#7E8299">If you didn't request a password reset, you can safely ignore this email. Your account is secure.</p>
                                        </div>
                                    </div>
                                    <!--end:Email content-->
                                </td>
                            ...
                            <tr>
                                <td align="center" valign="center" style="text-align:center; padding-bottom: 20px;">
                                    <a href="#" style="margin-right:10px">
                                        <img alt="Logo" src="{{ asset('public/backend') }}/media/email/icon-linkedin.svg" />
                                    </a>
                                    <a href="#" style="margin-right:10px">
                                        <img alt="Logo" src="{{ asset('public/backend') }}/media/email/icon-facebook.svg" />
                                    </a>
                                    <a href="#">
                                        <img alt="Logo" src="{{ asset('public/backend') }}/media/email/icon-twitter.svg" />
                                    </a>
                                </td>
                            </tr>
                            <tr>
