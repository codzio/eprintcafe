...
<style type="text/css">
  /*Remove Image CSS*/
  #customerAddressForm .checkbox label::after{
    left: 0!important;
  }
  #customerAddressBtn{
    font-size:17px;
...
.tab-container-main label::after{
  position:absolute;
  left:-19px;
}
            ...
            <div class="tab-content tab-2-content {{ ($cartData->count() && empty($action))? 'active':'disabled' }}" id="tab2">
                <div class="tab-content-inner">
                      <div class="tab-content-left">
                        ...
                        <div class="input-result-boxes-sec file-result-boxes-sec">
                          @if(!empty($cartData))
                        ...
                        <h6>SHIPPING DETAILS</h6>
                         <form id="customerAddressForm" method="post" action="{{ route('saveAddress') }}">
                            ...
                            <div class="biiling-submit-btn">
                              <button id="customerAddressBtn" type="submit" class="home_btn">SUBMIT</button>
                            </div>
...
<script type="text/javascript">
  ...
  const filterFiles = (el) => {
    ...
    $('.file-result-boxes-sec a').each(function() {
