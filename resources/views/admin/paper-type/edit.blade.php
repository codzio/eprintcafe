        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-header border-0 cursor-pointer">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Edit Paper Type</h3>
                </div>
                    ...
                    <div class="card-body border-top p-9">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <select class="form-select mb-2" name="paperSize" data-control="select2" data-hide-search="true" data-placeholder="Select Paper Size">
                                            ...
                                            <option {{ ($paperSz->id == $paperType->paper_size_id)? 'selected':''; }} value="{{ $paperSz->id }}">{{ $paperSz->size }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="paperType" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Paper Type" value="{{ $paperType->paper_type }}">
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="slug" type="text" name="slug" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Slug" value="{{ $paperType->paper_type_slug }}">
