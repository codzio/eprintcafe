    ...
    <div class="card-body d-flex flex-column justify-content-end pe-0">
        ...
        <div class="symbol-group symbol-hover flex-nowrap">
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
                                            <img alt="Pic" src="https://preview.keenthemes.com/metronic8/demo27/assets/media/avatars/300-11.jpg" />
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
                                            <span class="symbol-label bg-primary text-inverse-primary fw-bold">S</span>
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy">
                                            <img alt="Pic" src="https://preview.keenthemes.com/metronic8/demo27/assets/media/avatars/300-2.jpg" />
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Perry Matthew">
                                            <span class="symbol-label bg-danger text-inverse-danger fw-bold">P</span>
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Barry Walter">
                                            <img alt="Pic" src="https://preview.keenthemes.com/metronic8/demo27/assets/media/avatars/300-12.jpg" />
                                    </div>
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        <div class="menu-content px-3 py-3">
            <a class="btn btn-primary  btn-sm px-4" href="ecommerce.html#">
                Generate Reports
            </a>
        </div>
    </div>
        ...
        <ul class="nav nav-pills nav-pills-custom mb-3">
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4" data-bs-toggle="pill" href="ecommerce.html#kt_stats_widget_2_tab_1">
                    <!--begin::Icon-->
                    <div class="nav-icon">                                                                                          
                        <img alt="" src="{{ asset('public/backend') }}/media/svg/products-categories/t-shirt.svg" class=""/>                                                                                         
                    </div>
                    <!--end::Icon-->
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="ecommerce.html#kt_stats_widget_2_tab_2">
                    <!--begin::Icon-->
                    <div class="nav-icon"> 
                        <img alt="" src="{{ asset('public/backend') }}/media/svg/products-categories/gaming.svg" class=""/>                                                                               
                    </div>
                    <!--end::Icon-->
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="ecommerce.html#kt_stats_widget_2_tab_3">
                    <!--begin::Icon-->
                    <div class="nav-icon">                              
                        <img alt="" src="{{ asset('public/backend') }}/media/svg/products-categories/watch.svg" class=""/>                                                        
                    </div>
                    <!--end::Icon-->
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="ecommerce.html#kt_stats_widget_2_tab_4">
                    <!--begin::Icon-->
                    <div class="nav-icon">                              
                        <img alt="" src="{{ asset('public/backend') }}/media/svg/products-categories/gloves.svg" class="nav-icon"/>                                                       
                    </div>
                    <!--end::Icon-->
            ...
            <li class="nav-item mb-3">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="ecommerce.html#kt_stats_widget_2_tab_5">
                    <!--begin::Icon-->
                    <div class="nav-icon">                              
                        <img alt="" src="{{ asset('public/backend') }}/media/svg/products-categories/shoes.svg" class="nav-icon"/>                                                       
                    </div>
                    <!--end::Icon-->
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>                                             
                                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/210.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$126.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/215.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$76.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/209.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>                                             
                                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/197.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                                            <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-4312</span>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$312.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/178.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$62.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="https://preview.keenthemes.com/metronic8/demo27/assets/media/stock/ecommerce/22.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>                                             
                                            <img src="https://preview.keenthemes.com/metronic8/demo27/assets/media/stock/ecommerce/1.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$231.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="https://preview.keenthemes.com/metronic8/demo27/assets/media/stock/ecommerce/24.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$53.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="https://preview.keenthemes.com/metronic8/demo27/assets/media/stock/ecommerce/71.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>                                             
                                            <img src="https://preview.keenthemes.com/metronic8/demo27/assets/media/stock/ecommerce/41.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$163.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/63.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$73.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/59.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>                                             
                                            <img src="https://preview.keenthemes.com/metronic8/demo27/assets/media/stock/ecommerce/10.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$287.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/96.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-800 fw-bold d-block fs-6">$51.00</span>
                                                                    ...
                                                                    <tr>
                                        <td>                                             
                                            <img src="https://preview.keenthemes.com/metronic8/demo27/assets/media/stock/ecommerce/13.png" class="w-50px ms-n1" alt=""/>                                                
                                        </td>
                                        <td class="ps-0">
    ...
    <div class="card-body d-flex flex-column flex-center">  
        ...
        <div class="mb-2">
            ...
            <div class="py-10 text-center">
                                    <img src="{{ asset('public/backend') }}/media/svg/illustrations/easy/2.svg" class="theme-light-show w-200px" alt=""/>
                    <img src="{{ asset('public/backend') }}/media/svg/illustrations/easy/2-dark.svg" class="theme-dark-show w-200px" alt=""/>
                            </div>
            <!--end::Illustration-->
        </div>
        <!--end::Heading-->
                    ...
                    <td colspan="2">
                        <div class="d-flex align-items-center gap-3">
                            <a href="ecommerce.html#" class="symbol symbol-50px bg-secondary bg-opacity-25 rounded">
                                <img src="ecommerce.html" data-kt-src-path="/metronic8/demo27/assets/media/stock/ecommerce/" alt="" data-kt-table-widget-4="template_image" />
                            </a>
                    ...
                    <td></td>
                        ...
                        <td class="text-end">
                            <button type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
                                <i class="ki-outline ki-plus fs-4 m-0 toggle-off"></i>                                <i class="ki-outline ki-minus fs-4 m-0 toggle-on"></i>                            </button>
                        </td>
                    </tr>
                                    <tr>
                        <td>
        ...
        <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                ...
                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">                 
                    ...
                    <div class="d-flex flex-stack mb-3">
                        ...
                        <div class="me-3">            
                            <!--begin::Icon-->                         
                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/210.png" class="w-50px ms-n1 me-1" alt=""/>                  
                            <!--end::Icon--> 
...
<!--end::Menu 2-->
                ...
                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">                 
                    ...
                    <div class="d-flex flex-stack mb-3">
                        ...
                        <div class="me-3">            
                            <!--begin::Icon-->                         
                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/209.png" class="w-50px ms-n1 me-1" alt=""/>                  
                            <!--end::Icon--> 
...
<!--end::Menu 2-->
                ...
                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">                 
                    ...
                    <div class="d-flex flex-stack mb-3">
                        ...
                        <div class="me-3">            
                            <!--begin::Icon-->                         
                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/214.png" class="w-50px ms-n1 me-1" alt=""/>                  
                            <!--end::Icon--> 
...
<!--end::Menu 2-->
                ...
                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">                 
                    ...
                    <div class="d-flex flex-stack mb-3">
                        ...
                        <div class="me-3">            
                            <!--begin::Icon-->                         
                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/211.png" class="w-50px ms-n1 me-1" alt=""/>                  
                            <!--end::Icon--> 
...
<!--end::Menu 2-->
                ...
                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">                 
                    ...
                    <div class="d-flex flex-stack mb-3">
                        ...
                        <div class="me-3">            
                            <!--begin::Icon-->                         
                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/215.png" class="w-50px ms-n1 me-1" alt=""/>                  
                            <!--end::Icon--> 
...
<!--end::Menu 2-->
                ...
                <div class="border border-dashed border-gray-300 rounded px-7 py-3 ">                 
                    ...
                    <div class="d-flex flex-stack mb-3">
                        ...
                        <div class="me-3">            
                            <!--begin::Icon-->                         
                            <img src="{{ asset('public/backend') }}/media/stock/ecommerce/192.png" class="w-50px ms-n1 me-1" alt=""/>                  
                            <!--end::Icon--> 
