                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('../public/backend/media/svg/avatars/blank.svg')">
                                    ...
                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="modal" data-bs-target="#kt_app_engage_prebuilts_modal" title="Change Profile" onclick="loadMedia({addMediaBtn: true, multiple: false, mediaType: ['png', 'jpg', 'jpeg'], field: '#bannerImg'})">
                                        <i class="ki-outline ki-pencil fs-7"></i>
                                    </label>
                                    ...
                                    <span style="{{ $category->banner_img? '':'display:none;'; }}" id="bannerImgRemoveBtn" onclick="removeMedia({field: '#bannerImg', multiple: false})" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="remove" data-bs-toggle="tooltip" title="Remove Profile">
                                        <i class="ki-outline ki-cross fs-2"></i>                            
                                    </span>

                                    <input type="hidden" name="bannerImg" id="bannerImg" value="{{ $category->category_img }}">
                                </div>
                                <div class="form-text">Allowed file types:  png, jpg, jpeg.</div>
