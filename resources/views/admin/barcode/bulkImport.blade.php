        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-header border-0 cursor-pointer">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Add Barcode Bulk Import</h3>
                </div>


                <div class="card-title">
                    <a href="{{ asset('public/backend') }}/media/barcode_bulk_import.xlsx " download class="btn btn-primary">Sample File</a>
                    <a style="margin-left: 5px;" href="{{ route('adminBarcode') }}" class="btn btn-primary">Back</a>
                </div>

            </div>
            
            <div id="kt_account_settings_profile_details" class="collapse show">                
                <form id="kt_form" enctype="multipart/form-data" class="form" action="{{ route('adminDoBarcodeBulkImport') }}">
