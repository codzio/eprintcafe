                        ...
                        <div class="card-header pt-8">
                            ...
                            <div class="card-toolbar">
                                <div class="d-flex justify-content-end align-items-center d-none" data-kt-filemanager-table-toolbar="selected" style="padding-right: 8px">
                                    ...
                                    <button onclick="startBulkDelete(this)" data-url="{{ route('adminBulkPerDeleteOrder') }}" type="button" class="btn btn-danger" data-kt-filemanager-table-select="delete_selected">
                                        Delete Selected
                                    </button>

                                    <button style="margin-left:10px" onclick="startBulkRestore(this)" data-url="{{ route('adminBulkRestoreOrder') }}" type="button" class="btn btn-primary" data-kt-filemanager-table-select="delete_selected">
                                        Restore Selected
                                    </button>
                                </div>
                            </div>
