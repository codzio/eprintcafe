                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input readonly id="perSheetPrice" step=".01" type="number" name="perSheetPrice" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Per Sheet Rate" value="{{ $pricing->rate }}">
