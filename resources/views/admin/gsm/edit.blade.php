        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-header border-0 cursor-pointer">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Edit Paper GSM</h3>
                </div>
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">                
                <form id="kt_form_update" class="form" action="{{ route('adminDoUpdateGsm') }}">
                    <div class="card-body border-top p-9">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <select id="paperSize" class="form-select mb-2" name="paperSize" data-control="select2" data-hide-search="true" data-placeholder="Select Paper Size">
                                            ...
                                            <option {{ ($paperSz->id == $gsm->paper_size)? 'selected':'' }} data-measurement="{{ $paperSz->measurement }}" value="{{ $paperSz->id }}">{{ $paperSz->size }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="measurement" readonly type="number" step="0.01" name="measurement" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Measurement" value="{{ $gsm->measurement }}">
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="gsm" type="text" name="gsm" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="GSM" value="{{ $gsm->gsm }}">
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="weight" readonly type="number" step="0.01" name="weight" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="weight" value="{{ $gsm->weight }}">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <select id="paperType" class="form-select mb-2" name="paperType" data-control="select2" data-hide-search="true" data-placeholder="Select Paper Type">
                                            ...
                                            <option {{ ($paperType->id == $gsm->paper_type)? 'selected':''; }} value="{{ $paperType->id }}">{{ $paperType->paper_type }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="rate" type="number" step="0.0001" name="paperTypePrice" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Paper Type Price" value="{{ $gsm->paper_type_price }}">
                    ...
                    <div class="d-flex justify-content-end py-6 px-9">
                        ...
                        <input type="hidden" name="id" value="{{ $gsm->id }}">
