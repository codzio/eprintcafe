...
<style type="text/css">
                        ...
                        <div class="card-header pt-8">
                            <div class="card-title">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" onkeyup="search(this.value)" class="form-control form-control-solid w-250px ps-15" placeholder="Search Abandoned Cart" />
                                </div>
                            </div>
                            ...
                            <table id="kt_file_manager_list" data-kt-filemanager-table="files" class="table align-middle table-row-dashed fs-6 gy-5">
                                <thead>
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-50px" style="width:50px">Email</th>
                                        <th class="min-w-50px" style="width:50px">Phone</th>
                                        <th class="min-w-50px" style="width:50px">City</th>
    ...
    <script type="text/javascript">
        dataUrl = '{{ route("getAdminAbandonedCart") }}';        
    </script>

    <script src="{{ asset('public/backend') }}/plugins/custom/datatables/datatables.bundle.js"></script>
    <script src="{{ asset('public/backend/js/admin/abandoned-cart.js?v=1') }}"></script>
