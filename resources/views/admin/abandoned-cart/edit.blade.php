...
<div id="kt_app_content" class="app-content  flex-column-fluid " >
                    ...
                    <div class="card-body border-top p-9">
                                        ...
                                        <select id="binding" class="form-select mb-2" name="binding" data-control="select2" data-hide-search="false" data-placeholder="Select Binding">
                                            ...
                                            @if(!empty($bindingList) && $bindingList->count())
                                                @foreach ($bindingList as $binding)
                                                    <option {{ $binding->id == $productDetailIds->binding? 'selected':'' }} data-price="{{ $binding->price }}" value="{{ $binding->id }}">{{ $binding->binding_name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input type="number" name="additionalDiscount" class="form-control" value="{{ ($order->additional_discount)? checkDecimal($order->additional_discount):0 }}">
                        ...
                        <div class="red_text">
                           ...
                           <div>
                                ...
                                <p style="margin-top:10px"><strong>Weight:</strong><span id="cartWeight">{{ ($priceDetails->per_sheet_weight*$orderItem->qty)*$orderItem->no_of_copies }}</span></p>
                                <p><strong>Discount:</strong><span id="discountData">{{ $order->discount }}</span></p>
                                <p><strong>Additional Discount:</strong><span id="additionalDiscountData">{{ ($order->additional_discount)? checkDecimal($order->additional_discount):0 }}</span></p>
    ...
    <script src="{{ asset('public/backend/js/admin/customers.js?v=1') }}"></script>
