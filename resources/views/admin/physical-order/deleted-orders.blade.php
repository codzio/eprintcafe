...
<style type="text/css">
                        ...
                        <div class="card-header pt-8">
                            <div class="card-title">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" onkeyup="search(this.value)" class="form-control form-control-solid w-250px ps-15" placeholder="Search Orders" />
                                </div>
                            </div>
                            <div class="card-toolbar">
                                <div class="d-flex justify-content-end align-items-center d-none" data-kt-filemanager-table-toolbar="selected" style="padding-right: 8px">
                                    ...
                                    <button onclick="startBulkDelete(this)" data-url="{{ route('adminBulkPerDeletePhysicalOrder') }}" type="button" class="btn btn-danger" data-kt-filemanager-table-select="delete_selected">
                                        Delete Selected
                                    </button>

                                    <button style="margin-left:10px" onclick="startBulkRestore(this)" data-url="{{ route('adminBulkRestorePhysicalOrder') }}" type="button" class="btn btn-primary" data-kt-filemanager-table-select="delete_selected">
                                        Restore Selected
                                    </button>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        dataUrl = '{{ route("getAdminDeletedOrders") }}';        
    </script>
