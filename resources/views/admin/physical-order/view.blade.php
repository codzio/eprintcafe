                    ...
                    <div class="card-body border-top p-9">
                       ...
                       <table class="table table-bordered">
                           ...
                           <tr>
                               <th>Sub Total</th>
                               @if($adminData->role_id == 1)
                               <td style="color:red;font-weight:bold">{{ $order->paid_amount+$order->wallet_amount+$order->additional_discount }}</td>
                               @else
                               <td>XXXX</td>
                               @endif
                           </tr>
                           ...
                           <tr>
                               ...
                               @if($adminData->role_id == 1)
                               <td style="color:green;font-weight: bold;">{{ $order->wallet_amount }}</td>
                               @else
                               <td>XXXX</td>
                               @endif
                           </tr>
