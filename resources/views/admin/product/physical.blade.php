...
<link href="{{ asset('public/backend') }}/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css"/>
                        ...
                        <div class="card-header pt-8">
                            <div class="card-title">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" onkeyup="search(this.value)" class="form-control form-control-solid w-250px ps-15" placeholder="Search Product" />
                                </div>
                            </div>
                            <div class="card-toolbar">
                                ...
                                <a href="{{ route('adminAddPhysicalProduct') }}" class="btn btn-primary">Add Physical Product</a>
                            </div>
                        </div>
                        <!--end::Card header-->
    ...
    <script type="text/javascript">
        dataUrl = '{{ route("getAdminPhysicalProduct") }}';        
    </script>
