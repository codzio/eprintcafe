    ...
    <div id="kt_app_content_container" class="app-container container-fluid ">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">                
                <form id="kt_form" class="form" action="{{ route('adminDoAddPhysicalProduct') }}">
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="mrp" type="text" name="mrp" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="MRP" value="">
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="sp" type="text" name="sp" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="SP" value="">
