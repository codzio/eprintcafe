        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-header border-0 cursor-pointer">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Edit Physical Product</h3>
                </div>

                <div class="card-title">
                    <a href="{{ route('adminPhysicalProduct') }}" class="btn btn-primary">Back</a>
                </div>

            </div>
            
            <div id="kt_account_settings_profile_details" class="collapse show">                
                <form id="kt_form_update" class="form" action="{{ route('adminDoUpdatePhysicalProduct') }}">
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">                    
                            <label class="col-lg-3 col-form-label fw-semibold fs-6 required">MRP</label>
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="mrp" type="text" name="mrp" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="MRP" value="{{ $product->mrp }}">
                                        <span id="mrpErr" class="text-danger"></span>
                                    </div>                            
                                </div>
                            </div>                    
                        </div>
                        ...
                        <div class="row mb-6">                    
                            <label class="col-lg-3 col-form-label fw-semibold fs-6">SP</label>
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="sp" type="text" name="sp" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="SP" value="{{ $product->sp }}">
                                        <span id="spErr" class="text-danger"></span>
                                    </div>                            
                                </div>
                            </div>                    
                        </div>
