                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <textarea id="shortDescription" name="shortDescription" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Short Description">{{ $product->short_description }}</textarea>
                                        <span id="shortDescriptionErr" class="text-danger"></span>
                                    </div>                            
                                </div>
                            </div>                    
                        </div>
                        ...
                        <div class="row mb-6">                    
                            <label class="col-lg-3 col-form-label fw-semibold fs-6">Button Name</label>
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="buttonName" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Button Name" value="{{ $product->button_name }}">
                                        <span id="buttonNameErr" class="text-danger"></span>
                                    </div>                            
                                </div>
                            </div>                    
                        </div>
                        ...
                        <div class="row mb-6">                    
                            <label class="col-lg-3 col-form-label fw-semibold fs-6 required">Registered HSN Code</label>
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="registeredHsnCode" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Registered HSN Code" value="{{ $product->registered_hsn_code }}">
                                        <span id="registeredHsnCodeErr" class="text-danger"></span>
                                    </div>                            
                                </div>
                            </div>                    
                        </div>
                        ...
                        <div class="row mb-6">                    
                            <label class="col-lg-3 col-form-label fw-semibold fs-6 required">Unregistered HSN Code</label>
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="unregisteredHsnCode" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Unregistered HSN Code" value="{{ $product->unregistered_hsn_code }}">
                                        <span id="unregisteredHsnCodeErr" class="text-danger"></span>
                                    </div>                            
                                </div>
                            </div>                    
                        </div>
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input {{ ($product->display_on_home)? 'checked':'' }} type="checkbox" name="displayOnHome" value="1" class="form-control-lg form-control-solid mb-3 mb-lg-0">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-3 col-form-label fw-semibold fs-6">Banner Image</label>   
                            <div class="col-lg-9">
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('../public/backend/media/svg/avatars/blank.svg')">
                                    <div id="bannerImgDisplay" class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ $bannerImg }}')"></div>
                                    
                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="modal" data-bs-target="#kt_app_engage_prebuilts_modal" title="Change banner image" onclick="loadMedia({addMediaBtn: true, multiple: false, mediaType: ['png', 'jpg', 'jpeg'], field: '#bannerImg'})">
                                        <i class="ki-outline ki-pencil fs-7"></i>
                                    </label>
                                    ...
                                    <span style="{{ $product->banner_image? '':'display:none;'; }}" id="bannerImgRemoveBtn" onclick="removeMedia({field: '#bannerImg', multiple: false})" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="remove" data-bs-toggle="tooltip" title="Remove banner image">
                                        <i class="ki-outline ki-cross fs-2"></i>                            
                                    </span>

                                    <input type="hidden" name="bannerImg" id="bannerImg" value="{{ $product->banner_image }}">
                                </div>
                                <div class="form-text">Allowed file types:  png, jpg, jpeg.</div>
                                <span id="bannerImgErr" class="text-danger"></span>
                            </div>                                  
                        </div>
