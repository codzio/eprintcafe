        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-header border-0 cursor-pointer">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Add Binding</h3>
                </div>
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">                
                <form id="kt_form" class="form" action="{{ route('adminDoAddBinding') }}">
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="bindingName" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Binding Name" value="">
                        ...
                        <div class="row mb-6">                    
                            ...
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="price" type="number" min="1" name="price" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Price" value="">
                        ...
                        <div class="row mb-6">                    
                            <label class="col-lg-3 col-form-label fw-semibold fs-6">Split</label>
                            <div class="col-lg-9">                        
                                <div class="row">
                                    <div class="col-lg-12 fv-row">
                                        <input id="split" type="number" min="0" name="split" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Split" value="">
                                        <span id="splitErr" class="text-danger"></span>
                                    </div>                            
                                </div>
                            </div>                    
                        </div>
